...
def showStatus():
    ...
    # if 'drop_item' in rooms[currentRoom]:
    #     print('you see a ' + dropItem['name'])
    # print(roomItem):
...
while True:
    ...
    if move[0] == 'take':#NEED TO RESOLVE ISSUE
        ...
        if move[1] == rooms[currentRoom]['new_item']['name']:
            ...
            print(roomItemSecond)
            # roomItem =
            del rooms[currentRoom]['new_item']
            roomItemSecond = 0
            print(roomItemSecond)
        else:
            print('---------------')
    ...
    if move[0] == 'drop':
       drop_item(move[1])
        ...
        #     rooms[currentRoom]['drop_item'] = move[1]
        #     print(rooms[currentRoom]['drop_item'])
    ...
    if move[0] == 'stat':
        ...
        print('Equipped Weapon: ' + currentWeap['name'])
        # print('---------------')
